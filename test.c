...
// Define a structure for coupons
struct Coupon
{
    char code[20];
    float discount;
...
int main(void)
{
    struct Coupon myCoupon = {"SAVE10", 10.0, "2024-12-31"};
    // struct Coupon myCoupon = {"SAVE10", 10.0, "2023-12-31"};

    if (isCouponExpired(myCoupon.expiryDate))
    {
        printf("The coupon is expired.\n");
    }
    else
    {
        printf("The coupon is valid.\n");
    }
}
